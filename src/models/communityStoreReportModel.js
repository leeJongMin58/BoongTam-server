...
export const createStoreReport = async (lat, lng, address, name, storeType, appearanceDay, appearanceTime, paymentMethod, isOrderOnline = false) => {
    ...
    try {
        ...
        const storeDetailsQuery = `
            ...
            (store_id, store_type, appearance_day, appearance_time, payment_method) 
            VALUES (?, ?, ?, ?, ?)
        `;
